...
for i=0:8:4000
    ...
    if i>=2000 && i<=2360
        ...
        car7_Rz=[2*cos(car7_yaw) 2*-sin(car7_yaw) 0 car7_index(1,4)-3;
    ...
    elseif i>2360 && i<=2720
        ...
        car8_Rz=[2*cos(car8_yaw) 2*-sin(car8_yaw) 0 car8_index(1,4)-3;
    ...
    elseif i>2720 && i<=3080    
        ...
        car9_Rz=[2*cos(car9_yaw) 2*-sin(car9_yaw) 0 car9_index(1,4)-3;
        ...
        mycar_Rz=[2*cos(mycar_yaw) 2*-sin(mycar_yaw) 0 mycar_index(1,4)-8;
    ...
    axis([-400 800 -1800+i -800+i 0 300]);
    view(0,90); 
    elseif i>1200 && i<2920 % 검은차가 신호를 기다리는 구간
        axis([-400 800 -600 400 0 300]);
        view(0,90); 
    elseif i>=2920 % 검은차가 좌회전을 하는 구간
        axis([-400-(i-2920) 800 -600 400 0 300]);
        if i<=3100
        view((i-2920)/2,90); % 180을 갈 동안 0~90도로 뷰포인트를 바꿔야 하기 때문에
        axis([-300 500 -300 500 0 300]);
        end
        if i>3100 % 좌회전 끝내고 직진하는 구간
            view(90,90);
            axis([-300-(i-3100) 500-(i-3100) -300 500 0 300]);
        end
    end
